...
Literal             : INT                                                   {$$ = new LiteralInt($1);}                                                   
                    ...
                    | ELDA                                                  {$$ = new LiteralBool($1);}
                    | COBA                                                  {$$ = new LiteralBool($1);}
                    ;
...
Exp         : OPAR Exp CPAR                                                 {$$ = new Exp($2);}
            ...
            | Exp PLUS Exp                                                  {$$ = new BinaryExp($1, $3, $2)}
            | Exp MINUS Exp                                                 {$$ = new BinaryExp($1, $3, $2)}
            | Exp MULT Exp                                                  {$$ = new BinaryExp($1, $3, $2)}
            | Exp DIV Exp                                                   {$$ = new BinaryExp($1, $3, $2)}
            | Exp POTEN Exp                                                 {$$ = new BinaryExp($1, $3, $2)}
            | Exp INTDIV Exp                                                {$$ = new BinaryExp($1, $3, $2)}
            | Exp REST Exp                                                  {$$ = new BinaryExp($1, $3, $2)}
